        ...
        @if($currentStep === 'configuration')
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Factory Configuration</h3>
                    {{ $this->form }}
                </div>
            </div>
                    ...
                    @if($generationResults && $generationResults['success'])
                        <div class="space-y-4">
                            <div class="flex items-center space-x-2 text-green-600">
                                ...
                                <span class="font-medium">Factory generated successfully!</span>
                            </div>
            ...
            <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div class="bg-white rounded-lg p-6 max-w-sm mx-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-gray-900 font-medium">Generating factory...</span>
                    </div>
                </div>
            </div>
        @endif

...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-lg text-gray-600">CodeForge Database Studio provides extensive customization options through configuration files, custom templates, navigation overrides, and feature toggles to adapt the plugin to your specific workflow needs.</p>
        </div>

        <!-- Configuration Overview -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-4">Configuration System</h2>
            <p class="text-gray-600 mb-6">The plugin uses a comprehensive configuration system allowing you to customize every aspect of functionality, appearance, and behavior.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    ...
                    <p class="text-sm text-gray-600">License configuration, feature toggles, navigation settings, and plugin registration options.</p>
                </div>
                ...
                <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                    ...
                    <p class="text-sm text-gray-600">Enable/disable specific features, configure monitoring thresholds, and customize code generation behavior.</p>
                </div>
                ...
                <div class="bg-purple-50 p-4 rounded-lg border border-purple-200">
                    ...
                    <p class="text-sm text-gray-600">Custom stub templates, code generation patterns, and documentation templates for consistent output.</p>
                </div>
            </div>
        </div>
...
'health_monitoring' => [
    ...
    'allowed_operations' => [
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-8">
            ...
            <p class="text-gray-600 mb-6">CodeForge Database Studio uses customizable stub templates for all code generation. You can override default templates with your own versions.</p>
...
class CustomHealthListener
{
    public function handle(DatabaseHealthChecked $event)
    {
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-8">
            ...
            <p class="text-gray-600 mb-6">Configure different behaviors for development, staging, and production environments:</p>

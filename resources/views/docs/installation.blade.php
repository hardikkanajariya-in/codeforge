    ...
    <div class="animate-fade-in-up">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-8">
            <div class="p-6 border-b border-gray-200">
                ...
                <p class="text-gray-600 mt-2 ml-12">Add the package to your Laravel project using Composer</p>
            </div>
            <div class="p-6">
                ...
                <div class="bg-blue-50 rounded-lg p-4">
                    <p class="text-blue-800 text-sm">
                        <strong>Note:</strong> This package is commercially licensed. Ensure you have a valid license
                        before installing in production environments.
                    </p>
                </div>
            </div>
        </div>

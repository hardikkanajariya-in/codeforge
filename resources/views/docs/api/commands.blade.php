...
@section('title', 'Commands - CodeForge Database Studio')
...
@section('breadcrumbs')
    ...
    <li class='text-primary-600 font-medium'>Commands</li>
@endsection
...
<div class='bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center'>
    <h2 class='text-2xl font-bold text-gray-900 mb-4'>Commands Documentation</h2>

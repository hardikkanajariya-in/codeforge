...
@section('content')
    <div class="animate-fade-in-up">
        ...
        <div class="bg-gradient-to-r from-green-50 to-emerald-50 p-8 rounded-xl mb-8">
            ...
            <p class="text-gray-600 mb-6">
                ...
                endpoints, and application architecture. Generate comprehensive documentation in multiple formats with
                intelligent analysis and professional formatting.
            </p>
    ...
    CodeForgeStudioPlugin::make()
        ...
        <div class="bg-gray-50 p-4 rounded-md">
            <ul>
                ...
                <li><strong>Generation Tracking:</strong> Track documentation generation history with metadata and
                    statistics</li>
                <li><strong>Professional Formatting:</strong> Clean, professional documentation with proper styling</li>
            </ul>
        </div>
        ...
        <div class="bg-blue-50 p-8 rounded-xl mb-8">
            ...
            <p class="text-gray-600 mb-6">The documentation system is powered by specialized services:</p>
